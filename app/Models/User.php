...
class User extends Authenticatable
{
    ...
    use HasFactory;
    protected $fillable = ['name', 'cpf', 'phone', 'email', 'password', 'role', 'categories', 'specialties', 'average_rating', 'payment_methods', 'daily_value', 'description', 'is_banned', 'email_verified'];
